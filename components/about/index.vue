    ...
    <div class="card my-4 py-12 px-8">
      ...
      <div class="w-4/5 ml-10">
        <p class="text-xl text-gray-700 leading-relaxed font-medium">
          ...
          excitement, skills and doesn't bore you with too much information. I figred out the best way to do that was to
          tell my story using cards from the design tile on <a href="https://tailwindui.com/img/hero-pattern-lg.png"
                                                               class="text-teal-700"> Tailwind UI.</a>
        </p>
